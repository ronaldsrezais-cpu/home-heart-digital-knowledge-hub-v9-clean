    ...
    <main>
      ...
      <footer className="footer">
        <div className="container">
          ...
          <p>Developed as an open-access digital platform for inclusive family sport, online engagement, learning resources and long-term replication. EU funding visibility text and official programme logos can be added here once final files are available.</p>
        </div>
      </footer>
    </main>
  );
